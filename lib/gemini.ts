...
{
  "is_impostor": false,
  "description": "2-3 words that name this cone's archetype (kinda like a tarot archetype). Use simple words. try avoiding 'guardian', 'sentinel', 'sentry', etc. Slighltly sarcastic and slightly academic as if you're writing an anthropology report and philosophy with simple words.don't add ay punctuations after the words",

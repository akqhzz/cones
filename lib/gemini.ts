...
{
  "is_impostor": false,
  "description": "2-3 words that name this cone's archetype (kinda like a tarot archetype, try to think beyond the fact that it's a cone). focus on its special charcaterics/interaction with the environment, be a bit creative, no cliche. Use simple and short words. Slighltly sarcastic and slightly academic as if you're writing an anthropology report and philosophy with simple words.don't add ay punctuations after the words",

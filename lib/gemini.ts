...
{
  "is_impostor": false,
  "description": "2-3 words that name this cone's archetype (kinda like a tarot archetype). focus on its special charcaterics/interaction with the environment, be a bit creative, no cliche. Use simple words. Slighltly sarcastic and slightly academic as if you're writing an anthropology report and philosophy with simple words.don't add ay punctuations after the words",
